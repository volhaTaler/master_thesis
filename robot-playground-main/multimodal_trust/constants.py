...
left =  78 #70  # x left
top = 156 #55  # y top
right = 119 #265 #255  # x right
bottom = 197 #240  # y bottom
...
time3 = 1 # time wait after grid display. the initial value was 2, ewduce to 1
time4 = 1 # the initial value was 2, reduce to 1.
time5 = 1 # 5
time6 = 0.3
time7 = 3
...
repeats = 3 # new repeat = new q-matrix for this 'run'. We set repeats to 3 for online experiments, and to 10 for offline experiments.
